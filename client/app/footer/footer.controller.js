...
.controller('FooterCtrl', function ($scope, $window) {
  $scope.share = function($event, social){
    ...
    var socialURL   = {
      twitter: 'http://twitter.com/share?url='+ path +'&text=' + text,
      linkedin: "http://www.linkedin.com/shareArticle?mini=true&url="+encodedPath+"&title="+text+"&summary="+description+"&source="+encodedPath
    }
